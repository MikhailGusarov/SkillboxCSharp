...
namespace Example_1951
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Дополнительно: клиентам с хорошей кредитной историей 
            //                предлагать пониженую ставку по кредиту и 
            // повышенную ставку по вкладам
            // Добавить механизмы оповещений использую делегаты и события
            // Реализовать журнал действий, который будет хранить записи всех 
            // транзакций по счетам / вкладам / кредитам
            // 
            ...
            // Применить любой из подходов EF в проекте

            // Применить к текущему проекту рассмотренные в теме паттерны 
